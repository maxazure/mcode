...
from maxagent.llm import LLMClient, Message, create_llm_client
    ...
    def __init__(
        ...
        if tool_registry is None:
            self.tools = create_default_registry(
                self.project_root, allow_outside_project=allow_outside_project
            )
        else:
...
def create_orchestrator(
    ...
    **kwargs,
    ...
    Args:
        ...
        allow_outside_project: If True, allow file operations outside project (YOLO mode)
        max_iterations: Maximum tool call iterations per agent (overrides config)
