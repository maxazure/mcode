...
- `src/maxagent/utils/context_summary.py` - 上下文汇总与记忆存储核心实现
- `src/maxagent/utils/context.py` - ContextManager 上下文管理器
- `src/maxagent/core/agent.py` - Agent 中的记忆注入逻辑
- `src/maxagent/tools/memory.py` - search_memory 工具实现
- `tests/test_context_summary.py` - 上下文汇总测试
- `tests/test_memory_injection.py` - 记忆注入测试
